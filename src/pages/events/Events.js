      ...
      <Grid className="events-page">
        <Row>
          <Col md={12} sm={12} xs={12}>
            ...
            <p>Every experience begins with a vision. The only question we have for you is what’s the occasion? Kingsland
              Farm is the perfect venue for special events including weddings, family reunions, and weekend getaways.</p>

            <h3>Weddings:</h3>
            <p>You can see it now, your perfect wedding day. Surrounded by loving friends and family, as a sweet Georgia
            ...
            <p>It’s time to get the family together again, but it’s so tricky to find a destination that has something
